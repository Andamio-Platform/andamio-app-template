...
| Access Token | 2 | 3 | 67% | Partial |
| Courses | 6 | 9 | 67% | Partial |
| Course Modules | 7 | 11 | 64% | Partial |
| SLTs | 4 | 7 | 57% | Partial |
| Lessons | 3 | 6 | 50% | Partial |
| Assignments | 3 | 5 | 60% | Partial |
| Introductions | 3 | 4 | 75% | Partial |
| Assignment Commitments | 5 | 6 | 83% | Near Complete |
| Projects/Treasury | 4 | 4 | 100% | Complete |
| Tasks | 4 | 4 | 100% | Complete |
| Task Commitments | 1 | 7 | 14% | Minimal |
...
**~49 of ~74 endpoints used (~66%)**

See [api-coverage.md](./api-coverage.md) for detailed per-endpoint status.

### Key Unused Endpoints

| Endpoint | Priority | Reason |
|----------|----------|--------|
| `/assignment-commitment/create` | High | Learner enrollment - core flow blocker |
| `/lesson/update`, `/lesson/publish` | High | Creator editing - core flow blocker |
| `/task-commitments/*` (6 endpoints) | Medium | Contributor features not yet built |
| `/contributors/create` | Medium | Contributor onboarding not yet built |
| `/course-module/batch-*` | Low | Optimization endpoints |
| `/slt/reorder`, `/slt/update-index` | Low | Drag-and-drop not implemented |
