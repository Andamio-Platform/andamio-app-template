...
|------|----------|----------|-------|
| **Test wallet auth with multiple wallets** | `src/contexts/andamio-auth-context.tsx` | **High** | Eternl tested and working (2026-01-18). Auth flow fixed in Session 20. Need to verify: Nami, Flint, Yoroi, Lace, Vespr. Document which wallets return hex vs bech32 addresses in CLAUDE.md wallet compatibility table. |
