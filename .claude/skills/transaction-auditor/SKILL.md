...
| Project Owner | `PROJECT_OWNER_MANAGERS_MANAGE` | `managers_manage` | `/api/v2/tx/project/owner/managers/manage` |
...
| Project Contributor | `PROJECT_CONTRIBUTOR_TASK_COMMIT` | `project_join` | `/api/v2/tx/project/contributor/task/commit` |
