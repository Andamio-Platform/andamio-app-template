...
exports.COURSE_TEACHER_MODULES_MANAGE = void 0;
exports.formatModulesPending = formatModulesPending;
exports.formatModulesConfirm = formatModulesConfirm;
exports.formatBatchUpdateStatusBody = formatBatchUpdateStatusBody;
exports.formatBatchConfirmBody = formatBatchConfirmBody;
...
const txName = "COURSE_TEACHER_MODULES_MANAGE";
/**
    ...
    buildTxConfig: {
        ...(0, schema_helpers_1.createSchemas)({
            ...
            txParams: zod_1.z.object({
                ...
                modules_to_mint: zod_1.z.array(zod_1.z.object({
                    slts: zod_1.z.array(zod_1.z.string()), // Array of SLT strings
                    allowed_course_state_ids: zod_1.z.array(zod_1.z.string().length(56)), // LocalStateNFT minting policy IDs (GYMintingPolicyId)
                    prereq_slt_hashes: zod_1.z.array(zod_1.z.string().length(64)), // Prerequisite SLT hashes (SltHash)
                })),
                modules_to_update: zod_1.z.array(zod_1.z.object({
                    slt_hash: zod_1.z.string().length(64), // Module hash to update (SltHash)
                    allowed_course_state_ids: zod_1.z.array(zod_1.z.string().length(56)), // LocalStateNFT minting policy IDs (GYMintingPolicyId)
                    prereq_slt_hashes: zod_1.z.array(zod_1.z.string().length(64)), // Prerequisite SLT hashes (SltHash)
                })),
                modules_to_burn: zod_1.z.array(zod_1.z.string().length(64)), // SLT hashes of modules to burn (SltHash)
            ...
            sideEffectParams: zod_1.z.object({
                ...
                modules_pending: zod_1.z.array(zod_1.z.object({
                    module_code: zod_1.z.string(),
                ...
                modules_confirm: zod_1.z.array(zod_1.z.object({
                    module_code: zod_1.z.string(),
                    module_hash: zod_1.z.string().length(64),
                })),
            }),
        }),
        ...
        inputHelpers: {
            modules_pending: {
                ...
                description: "Constructs the modules_pending array for sideEffectParams. " +
...
const sideEffectParams = { modules_pending, modules_confirm: [] };`,
            ...
            modules_confirm: {
                ...
                description: "Constructs the modules_confirm array for sideEffectParams. " +
 ...
 * ```
 */
function formatModulesPending(moduleCodes, txHash) {
 ...
 * ```
 */
function formatModulesConfirm(moduleCodes, moduleHashes) {
    if (moduleCodes.length !== moduleHashes.length) {
        throw new Error(`Module codes and hashes arrays must have the same length. ` +
 ...
 * ```
 */
function formatBatchUpdateStatusBody(courseNftPolicyId, moduleCodes, txHash) {
    return {
 ...
 * ```
 */
function formatBatchConfirmBody(courseNftPolicyId, moduleCodes, txHash, moduleHashes) {
    return {
        course_nft_policy_id: courseNftPolicyId,
        tx_hash: txHash,
