 ...
 */
export type TxName = "PUBLISH_TX" | "ADD_COURSE_MANAGERS" | "ADD_PROJECT_MANAGERS" | "INIT_COURSE" | "ADD_COURSE_CREATORS" | "RM_COURSE_CREATORS" | "INIT_PROJECT_STEP_1" | "INIT_PROJECT_STEP_2" | "INIT_SINGLE_CONTRIBUTOR_STATE" | "ADD_PROJECT_CREATORS" | "RM_PROJECT_CREATORS" | "MINT_MODULE_TOKENS" | "ACCEPT_ASSIGNMENT" | "DENY_ASSIGNMENT" | "MINT_TREASURY_TOKEN" | "MANAGE_TREASURY_TOKEN" | "ACCEPT_PROJECT" | "REFUSE_PROJECT" | "DENY_PROJECT" | "MINT_PROJECT_STATE" | "BURN_PROJECT_STATE" | "COMMIT_PROJECT" | "SUBMIT_PROJECT" | "ADD_INFO" | "GET_REWARDS" | "UNLOCK_PROJECT" | "MINT_LOCAL_STATE" | "BURN_LOCAL_STATE" | "COMMIT_TO_ASSIGNMENT" | "UPDATE_ASSIGNMENT" | "LEAVE_ASSIGNMENT" | "GLOBAL_GENERAL_ACCESS_TOKEN_MINT" | "INSTANCE_COURSE_CREATE" | "INSTANCE_PROJECT_CREATE" | "COURSE_OWNER_TEACHERS_MANAGE" | "COURSE_TEACHER_MODULES_MANAGE" | "COURSE_TEACHER_ASSIGNMENTS_ASSESS" | "COURSE_STUDENT_ASSIGNMENT_COMMIT" | "COURSE_STUDENT_ASSIGNMENT_UPDATE" | "COURSE_STUDENT_CREDENTIAL_CLAIM" | "PROJECT_OWNER_MANAGERS_MANAGE" | "PROJECT_OWNER_BLACKLIST_MANAGE" | "PROJECT_MANAGER_TASKS_MANAGE" | "PROJECT_MANAGER_TASKS_ASSESS" | "PROJECT_CONTRIBUTOR_TASK_COMMIT" | "PROJECT_CONTRIBUTOR_TASK_ACTION" | "PROJECT_CONTRIBUTOR_CREDENTIAL_CLAIM";
/**
 ...
 */
export type TransactionRole = "general" | "admin" | "course-creator" | "teacher" | "project-creator" | "contributor" | "student" | "instance-owner" | "course-owner" | "course-teacher" | "course-student" | "project-owner" | "project-manager" | "project-contributor";
/**
...
export type MintModuleV2 = {
    slts: string[];
    allowed_students_v2: string[];
    prerequisite_assignments_v2: string[];
};
/**
