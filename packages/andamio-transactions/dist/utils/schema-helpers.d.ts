 ...
 * ```
 */
export declare function mergeSchemas(txApiSchema: z.ZodObject<any>, sideEffectSchema?: z.ZodObject<any>): z.ZodObject<any>;
/**
 ...
 * ```
 */
export declare function createSchemas(params: CreateSchemasParams): {
    txApiSchema: z.ZodObject<any, z.UnknownKeysParam, z.ZodTypeAny, {
        [x: string]: any;
    }, {
        [x: string]: any;
    }>;
    sideEffectSchema: z.ZodObject<any, z.UnknownKeysParam, z.ZodTypeAny, {
        [x: string]: any;
    }, {
        [x: string]: any;
    }> | undefined;
    inputSchema: z.ZodObject<any, z.UnknownKeysParam, z.ZodTypeAny, {
        [x: string]: any;
    }, {
        [x: string]: any;
    }>;
