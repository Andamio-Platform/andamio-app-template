  ...
  return (
    <div
      ...
      className={cn(
        ...
        // Error state
        "aria-invalid:border-destructive data-[active=true]:aria-invalid:border-destructive data-[active=true]:aria-invalid:ring-2 data-[active=true]:aria-invalid:ring-destructive/20",
        // Dark mode
