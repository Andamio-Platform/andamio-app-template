/**
 * @deprecated V1 PATTERN - Use useTxWatcher from use-tx-watcher.ts instead
 *
 * This hook uses client-side Koios polling via cardano-indexer.ts which is
 * replaced by the Gateway TX State Machine pattern. All TX components now use
 * `useTxWatcher` which polls `/api/v2/tx/status/{hash}` (Gateway handles confirmation).
 *
 * This file will be removed in a future release.
 *
 * @see ~/hooks/tx/use-tx-watcher.ts - V2 pattern (use this)
